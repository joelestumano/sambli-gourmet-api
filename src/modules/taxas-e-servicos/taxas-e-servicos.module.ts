...
import { TaxaServico, TaxasEServicosSchema } from './entities/taxas-e-servicos.entity';
...
@Module({
  ...
  imports: [MongooseModule.forFeature([{ name: TaxaServico.name, schema: TaxasEServicosSchema }])],
